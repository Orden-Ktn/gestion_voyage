            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <div class="card-title">Ajout de Logement</div>
                </div>
                <div class="card-body">
                  <div class="row">
                    <form action="validation_add_logement.php" method="post" enctype="multipart/form-data">
                      <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-md-12">
                          <div class="form-group form-group-default">
                            <label>Photo</label>
                            <input id="addPhoto" type="file" name="photo" class="form-control" accept="image/*"
                              required />
                          </div>
                        </div>
